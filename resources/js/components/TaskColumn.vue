    ...
    <div class="p-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center mb-4">
                <label for="default-checkbox" class="ml-2 text-md font-medium text-white mr-2">Completion</label>
                <input id="default-checkbox" type="checkbox" v-model="isCompletion" @change="handleCardCompletion" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            </div>
            <PlusIcon
                @click="createTask()"
...
onMounted(() => {
    isCompletion.value = props.is_completion;
})

const handleCardCompletion = async () => {

    await kanban.updatePhase(props.phase_id, {isCompletion: isCompletion.value})
}
